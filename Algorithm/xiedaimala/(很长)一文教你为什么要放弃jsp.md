...
那么我们来看，我们先假设你的首页中有100张图片，此时，用户的看似一次http请求，其实并不是一次，用户在第一次访问的时候，浏览器中不会有缓存，你的100张图片，浏览器要连着请求100次http请求(有人会跟我说http长连短连的问题，不在这里讨论)，你的服务器接收这些请求，都需要消耗内存去创建socket来玩tcp传输(消耗你服务器上的计算资源)。
